...
func TestUserControllerInterface_FindUserByEmail(t *testing.T) {
	...
	t.Run("email_is_valid_returns_error", func(t *testing.T) {
		recorder := httptest.NewRecorder()
		context := GetTestGinContext(recorder)
		...
		service.EXPECT().FindUserByEmailServices("test@test.com").Return(nil, rest_error.NewInternalServerError("error test"))
...
func TestUserControllerInterface_FindUserByID(t *testing.T) {
	...
	t.Run("email_is_valid_returns_error", func(t *testing.T) {
		...
		service.EXPECT().FindUserByIDServices(id).Return(nil, rest_error.NewInternalServerError("error test"))
