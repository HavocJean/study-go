...
// Source: internal/model/repository/user_repository.go
//
// Generated by this command:
//
//	mockgen -source=internal/model/repository/user_repository.go -destination=internal/tests/mocks/user_repository_mock.go -package=mocks
//
...
func (m *MockUserRepository) CreateUser(userDomain model.UserDomainInterface) (model.UserDomainInterface, *rest_error.RestError) {
	m.ctrl.T.Helper()
...
func (m *MockUserRepository) DeleteUser(userId string) *rest_error.RestError {
	m.ctrl.T.Helper()
...
func (m *MockUserRepository) FindUserByEmail(email string) (model.UserDomainInterface, *rest_error.RestError) {
	m.ctrl.T.Helper()
...
func (m *MockUserRepository) FindUserByEmailAndPassword(email, password string) (model.UserDomainInterface, *rest_error.RestError) {
	m.ctrl.T.Helper()
...
func (m *MockUserRepository) FindUserByID(id string) (model.UserDomainInterface, *rest_error.RestError) {
	m.ctrl.T.Helper()
...
func (m *MockUserRepository) UpdateUser(userId string, userDomain model.UserDomainInterface) *rest_error.RestError {
	m.ctrl.T.Helper()
