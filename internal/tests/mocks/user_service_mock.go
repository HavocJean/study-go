...
// Source: internal/model/service/user_interface.go
//
// Generated by this command:
//
//	mockgen -source=internal/model/service/user_interface.go -destination=internal/tests/mocks/user_service_mock.go -package=mocks
//
...
import (
	...
	rest_error "github.com/HavocJean/study-go/internal/config/rest_error"
	model "github.com/HavocJean/study-go/internal/model"
...
func (m *MockUserDomainService) CreateUserServices(arg0 model.UserDomainInterface) (model.UserDomainInterface, *rest_error.RestError) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateUserServices", arg0)
	ret0, _ := ret[0].(model.UserDomainInterface)
	ret1, _ := ret[1].(*rest_error.RestError)
	return ret0, ret1
}
...
func (m *MockUserDomainService) DeleteUserServices(arg0 string) *rest_error.RestError {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DeleteUserServices", arg0)
	ret0, _ := ret[0].(*rest_error.RestError)
	return ret0
}
...
func (m *MockUserDomainService) FindUserByEmailServices(email string) (model.UserDomainInterface, *rest_error.RestError) {
	m.ctrl.T.Helper()
...
func (m *MockUserDomainService) FindUserByIDServices(id string) (model.UserDomainInterface, *rest_error.RestError) {
	m.ctrl.T.Helper()
...
func (m *MockUserDomainService) LoginUserServices(userDomain model.UserDomainInterface) (model.UserDomainInterface, string, *rest_error.RestError) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "LoginUserServices", userDomain)
	ret0, _ := ret[0].(model.UserDomainInterface)
	ret1, _ := ret[1].(string)
	ret2, _ := ret[2].(*rest_error.RestError)
...
func (m *MockUserDomainService) UpdateUserServices(arg0 string, arg1 model.UserDomainInterface) *rest_error.RestError {
	m.ctrl.T.Helper()
